...
├── export_novo_repo/             ← CAMADA 3: ESTE PROJETO (dados da revisão)
...
|---|---|---|
| 🛠️ **Kit de Agentes** | `vitalia-platform/vitalia-agent-kit` | Agentes, skills, regras e workflows. Atualizado centralmente e compartilhado entre projetos. |
| 🧠 **Contexto** | `vitalia-platform/vitalia-01-context` | Memória persistente da sessão de trabalho da IA entre máquinas. |
| 📚 **Revisão** | `vitalia-platform/revisao` | Os dados, configurações e artefatos desta revisão científica específica. |
...
> *Este repositório opera sob a metodologia Mendes, Silveira e Galvão (2008) e segue as diretrizes PRISMA para máxima rastreabilidade e publicabilidade.*
